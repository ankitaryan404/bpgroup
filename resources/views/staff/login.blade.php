...
<head>
    ...
    <title>Marketing Staff Login</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="splash-container">
        <div class="card ">
            ...
            <div class="card-body">
                <form method="POST" action="{{route('staff.auth')}}">
                    @csrf
                    <div class="form-group">
                        
                        <input class="form-control form-control-lg" name="username" type="text" placeholder="Enter email id" autocomplete="off">
                    </div>
                    <div class="form-group">
