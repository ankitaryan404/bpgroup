...
@section('title','Add Residential')
@section('small','Residential')
@section('residential','active')
@section('section')

                        <form enctype="multipart/form-data" method="POST" action="{{url('marketing-staff/residential/manage-residential')}}">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-12 col-sm-8 col-lg-6">
                                    <input type="text"  class="form-control" placeholder="Rs../- per sqft per month" name="rent_p_month" rent_p_month}}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-12 col-sm-3 col-form-label text-sm-right"> CAM</label>
                                <div class="col-12 col-sm-8 col-lg-6">
                                    <input type="text"  class="form-control" placeholder="Rs../- per sqft per month" name="cam" cam}}">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-12 col-sm-8 ol-lg-6">
