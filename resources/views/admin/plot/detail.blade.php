...
@section('title','Commercial Property Details')
@section('commercial','active')
@section('section')
                ...
                <div class="page-header">
                    ...
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{url('admin/commercial')}}" class="breadcrumb-link">Commercial</a></li>
