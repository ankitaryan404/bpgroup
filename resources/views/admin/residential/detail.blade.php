...
@section('title','Residential Property Details')
@section('resiential','active')
@section('section')
                ...
                <div class="page-header">
                    ...
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{url('admin/resiential')}}" class="breadcrumb-link">Residential</a></li>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="d-inline-block">
                                <h5 class="text-muted">Number of room</h5>
                                <h2 class="mb-0">{{$data->no_of_room}}</h2>
                            </div>
                    ...
                    <div class="card">
                        <div class="campaign-table table-responsive">
                            <table class="table">
                                <thead>
                                    <tr class="border-0">
                                        <th class="border-0">Car Parking</th>
                                        <th class="border-0">State of Handover</th>
