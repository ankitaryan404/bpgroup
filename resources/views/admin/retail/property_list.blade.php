...
@section('title','Retail Property List')
    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="page-header">
                <h3 class="mb-2">Retail Property List</h3>
                <div class="page-breadcrumb">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Admin</a></li>
                            <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Retail</a></li>
            ...
            <div class="card">
                <div class="card-body">
                    <form>
                        ...
                        <button class="btn btn-primary search-btn" type="button" onclick="funsearch('retail')">Search</button>
                    </form>
                </div>
            </div>
        </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-9 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="user-avatar float-xl-left pr-5 float-none">
                                ...
                                @if($data->status==1)
                                <a href="{{url('admin/retail/status/0')}}/{{$data->id}}" class="btn btn-success">Active</a>
                             @elseif($data['status']==0)
                                <a href="{{url('admin/retail/status/1')}}/{{$data->id}}" class="btn btn-warning">Deactive</a>
                            @endif
                            <a href="{{url('admin/retail/delete/'.$data->id)}}" class="mr-1 btn btn-danger">Delete</a>
                            <a href="{{url('admin/retail/manage/'.$data->id)}}" class="mr-1 btn btn-primary">Edit</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="float-xl-right float-none mt-xl-0 mt-4">
                                    <a href="{{url('admin/retail/detail/'.$data->id)}}" class="btn btn-info">View Details</a>
                                </div>
                            </div>
                        </div>
                    </div>
