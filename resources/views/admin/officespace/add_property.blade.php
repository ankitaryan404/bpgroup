...
@section('title','Manage Office space')
                ...
                <div class="page-breadcrumb">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{url('admin/officespace')}}" class="breadcrumb-link">Office Space</a></li>
        ...
        <div class="row">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form enctype="multipart/form-data" method="POST" action="{{url('admin/officespace/manage-officespace')}}">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-12 col-sm-8 col-lg-6">
                                    <input  type="text" class="form-control" name="ideal_for_business" value="{{$ideal_for_business}}">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-12 col-sm-8 col-lg-6">
                                    <select class="form-control" name="personal_washroom">
                                        @if($personal_washroom=='1')
                                        <option value="1" selected>Yes</option>
                                        <option value="0">No</option>
                                     @elseif($personal_washroom=='0')
                                     <option value="0" selected>No</option>
                                     <option value="1">Yes</option>
                                     @else
                                     <option value="">Select value</option>
